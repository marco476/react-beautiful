...
var CustomSnack = (0, _styledComponents["default"])(_Snackbar["default"])(_templateObject(), function (props) {
  return props.variant === 'success' && "background-color: ".concat(_green["default"][400], ";");
}, function (props) {
  return props.variant === 'fail' && "background-color: ".concat(_red["default"][400], ";");
});
...
var Snack = function Snack(_ref) {
  var onExited = _ref.onExited,
      ...
      rest = _objectWithoutProperties(_ref, ["onExited", "action", "showClose"]);
...
Snack.propTypes = {
  onExited: _propTypes.func.isRequired,
